...
<head>
    <meta charset="UTF-8">
    <title>Contact Us - HeartHealth</title>
...
<body>
    ...
    <section class="hero">
        <h1>Contact Us</h1>
        <p>We would love to hear from you. Send us a message and our team will get back to you shortly.</p>
    </section>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <p><strong>Email:</strong> support@hearthealth.com</p>
            <p><strong>Phone:</strong> +1 (555) 123-4567</p>
            <p><strong>Address:</strong> 123 Heart Avenue, Healthy City, USA</p>
        </div>
    </div>
